...
//----------------------------------------------------
        ...
        // fwrite($myfile, gzencode(json_encode($result), 9));
        // fclose($myfile);
        
        // $attachment_location = "./data/timetables/2021-2022 Birinchi semestr/rooms/AbIVBCghtWclQI.json";
        // header($_SERVER["SERVER_PROTOCOL"] . " 200 OK");
        // header("Cache-Control: public"); // needed for internet explorer
        // header("Content-Type: application/json");
        // header("Content-Transfer-Encoding: Binary");
        // header("Content-Length:".filesize($attachment_location));
        // header("Content-Disposition: attachment; filename=AbIVBCghtWclQI.json");
        ...
        $res;
        $res->status = 200;
        // $res->data = base64_encode(gzencode(json_encode($result), 9));
